...
export default async function Footer() {
    ...
    return (
        <footer className={"mt-4 block"}>
            <nav
                className="mx-auto h-full flex flex-row flex-wrap max-w-7xl items-center justify-start gap-16 p-8 lg:px-16 border-solid border-t border-gray-400/30 dark:border-gray-50/30">
                {
