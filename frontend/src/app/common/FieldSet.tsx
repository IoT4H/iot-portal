...
export function FieldSetInput(p: any) {
    ...
    return (
        <div className={`relative flex flex-col h-auto ${props.className || ""}`}>
            ...
            <div className="mt-2">
                { props.multiline ?
                  <textarea name={props.id} {...props}
                            className=" block h-[5em] resize-none w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-400 sm:text-sm sm:leading-6 disabled:bg-gray-500 disabled:ring-gray-800"></textarea> :
...
export function FieldSetSelect(p: any) {
    ...
    return (
        <div className={`relative flex flex-col ${props.className || ""}`}>
          ...
          <select
            className="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-400 sm:text-sm sm:leading-6  disabled:bg-gray-500 disabled:ring-gray-800" {...props}>
        ...
        <>
            <div className={`relative block group/checkbox ${props.className || ""}`}>
                <label htmlFor={props.id}
                    ...
                    <div>
                      {props.label || Array.isArray(children) && children.map((child: any) => {
                            return child;
                      }) || children}
