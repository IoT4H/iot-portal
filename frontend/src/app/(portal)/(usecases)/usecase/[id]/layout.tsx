                        ...
                        <div className={"flex md:flex-row flex-col gap-8"}>
                            ...
                            >
                                <div className={"pr-12 relative"}>
                                    ...
                                    <div
                                        className={
                                            "block w-min border-solid border-b-4 pr-2 border-orange-500 "
                                        }
                                    >
                                        <h1
                                            className={
                                                "dark:text-white font-bold text-3xl capitalize "
                                            }
                                        >
                                            {useCase.title}
                                        </h1>
                                ...
                                <p
                                    className={
                                        "text-sm text-gray-600 dark:text-gray-200 text-justify"
                                    }
                                >
                                    {" "}
                                    {useCase.summary ||
