            ...
            <div className={"flex md:flex-row flex-col gap-8"}>
              {
                useCase.thumbnail?.formats?.medium?.url || useCase.thumbnail?.url ? (
                  ...
                  >
                    <GalleryImage thumbnailSrc={getStrapiURLForFrontend() + (useCase.thumbnail?.formats?.medium?.url || useCase.thumbnail.url)} src={getStrapiURLForFrontend() + useCase.thumbnail.url} alt={useCase.thumbnail.alternativeText} caption={useCase.thumbnail.caption}
              ...
              <div className={"flex flex-shrink flex-col w-full md:w-6/12 min-w-6/12 gap-4"}>
                <div className={"pr-12 relative"}>
                  ...
                  <div className={"block w-min border-solid border-b-4 pr-2 border-orange-500 "}><CustomMarkdown className={"dark:text-white font-bold text-3xl capitalize "}>{useCase.title}</CustomMarkdown></div>
                </div>
