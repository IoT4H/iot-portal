...
export default function Page() {
    ...
    return <div
        ...
        <form className="flex-auto max-h-full w-full sticky top-0 pl-4" onSubmit={(event) => {event.preventDefault();forgotPassword();}}>
            ...
            <div className={" flex flex-col gap-y-8 w-full max-w-xl px-4 mx-auto"}>
                ...
                <div className={"mt-4"}>
                    <FieldSetInput className={"w-full"} label={"Email"} id={"email"} type={"email"} required
                                   autoComplete={"email"}
